...
def extract_kart_objects(
    ...
    for det in detections:
        ...
        # Get Kart Name
        # Guard against index out of bounds if metadata is missing
        kart_name = "unknown"
...
def generate_qa_pairs(info_path: str, view_index: int, img_width: int = 150, img_height: int = 100) -> list:
    ...
    for k in karts:
        ...
        # Standard perspective: Higher in image (smaller y) = Further away = Front
        # Lower in image (larger y) = Closer to camera = Behind (visually)
